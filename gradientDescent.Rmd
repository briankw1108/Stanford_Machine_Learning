...
print(paste("Initial J = ", round(J, 3), sep = ""))
...
plot(alltheta[, 1], alltheta[, 2], main = "thetas", xlab = "theta_0", ylab = "theta_1")
...
print(paste("Optimized J = ", round(tail(all_J, 1), 3), sep = ""))
plot(all_J, main = "Cost Function J Values", xlab = "Iteration", ylab = "J Value")
